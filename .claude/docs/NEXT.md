...
4. **marketing_agency** (luna carry 5/3, ARC 호환성 연결 5/4) — 7 카테고리 multi-product 컨테이너. active 4 (sales_offline/marketing_online/analytics/dev_products) + placeholder 3 (education/branding/smb). 가격 38/56/95만 frozen. launch 0건.
   - 다음 동작: active 4개 중 1개 pick → MODES.md Phase 1 PLAN.md (ICP/기능 ≤3/흐름/30일 죽일 기준). 추천: sales_offline (메인 사업).
   - 사례: `raw/molds/my/marketing_agency.md`
   - DECISIONS frozen: `projects/marketing_agency/DECISIONS.md` (가격/lineup, AI 변경 금지)
